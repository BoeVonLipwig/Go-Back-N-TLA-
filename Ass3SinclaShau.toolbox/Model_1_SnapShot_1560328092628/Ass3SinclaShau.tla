...
vars == <<sendDataQueue, receiveDataQueue, receiveReqQueue, sendReqQueue, requestNum, sequenceNum, windowStart, windowEnd, mess, messOut, senderState, reciverState, synNum>>
...
dataChannel ==  /\  dataWir!Next
                /\  UNCHANGED <<receiveReqQueue, sendReqQueue, requestNum, sequenceNum, windowStart, windowEnd, mess, messOut, senderState, reciverState, synNum>>

reqChannel ==  /\  reqWir!Next
               /\  UNCHANGED <<sendDataQueue, receiveDataQueue, requestNum, sequenceNum, windowStart, windowEnd, mess, messOut, senderState, reciverState, synNum>>
...
reciverChannel == /\  reciver!Next
                  /\  UNCHANGED <<sendDataQueue, receiveReqQueue, sequenceNum, windowStart, windowEnd, mess , senderState>>
...
\* Last modified Wed Jun 12 20:25:46 NZST 2019 by sdmsi
