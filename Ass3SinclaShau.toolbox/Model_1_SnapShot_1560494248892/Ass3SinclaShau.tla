...
(*
     ...
     * sequenceNum and reciverNum always start at 1 
     * The whole Spec works as following:
        ...
        * Send and recive using the sliding window 
     ...
     * Sender :
        ...
        * when it had recived confimation of all sent 
     * Recevier:
        * Started from scratch
...
\* Last modified Fri Jun 14 18:37:07 NZST 2019 by sdmsi
